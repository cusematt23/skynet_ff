...
from db import DB#db.py not a db module
...
class DBTest(unittest.TestCase):
    ...
    def test_build_select_query(self):
        ...
        # (table, column_filter, row_filter) input
        # (query_string, result) output
        tests = [
            (
                # Unit test 1
    ...
    def test_build_insert_query(self):
        # what we're going to input
        # what we expect to output
        tests = [
            (
                ("student", {"ID": 1}),
